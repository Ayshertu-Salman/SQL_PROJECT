...
SELECT COUNT(*) AS Number_of_rows FROM SALESORDER; -- THE NUMBER OF ROWS IN SALESORDER IS 830
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS;
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'SALESORDER' ; -- THE NUMBER OF COULUMNS IN SALESORDER IS 14
 




SELECT COUNT(*) AS Number_of_rows FROM CATEGORY; -- THE NUMBER OF ROWS IN CATEGORY IS 8
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS;
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'CATEGORY' ; -- THE NUMBER OF COULUMNS IN CATEGORY IS 7
 (
...
CREATE TABLE Region (
  ...
  SELECT COUNT(*) AS Number_of_rows FROM REGION; -- THE NUMBER OF ROWS IN REGION IS 4
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS;
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'REGION' ; -- THE NUMBER OF COULUMNS IN REGION IS 2
...
CREATE TABLE Territory (
  ...
  SELECT COUNT(*) AS Number_of_rows FROM TERRITORY; -- THE NUMBER OF ROWS IN TERRITORY IS 53
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS;
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'TERRITORY' ; -- THE NUMBER OF COULUMNS IN TERRIOTORY IS 3
...
CREATE TABLE CustomerDemographics (
  ...
  SELECT COUNT(*) AS Number_of_rows FROM CUSTOMERDEMOGRAPHICS; -- THE NUMBER OF ROWS IN CUSTOMERDEMOGRAPHICS IS 0
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS;
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'CUSTOMERDEMOGRAHICS' ; -- THE NUMBER OF COULUMNS IN CUSTOMERDEMOGRAPHICS IS 0
...
CREATE TABLE Customer (
  ...
  SELECT COUNT(*) AS Number_of_rows FROM CUSTOMER; -- THE NUMBER OF ROWS IN CUSTOMER IS 91
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS;
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'CUSTOMER' ; -- THE NUMBER OF COULUMNS IN CUSTOMER 22
...
CREATE TABLE CustCustDemographics (
  ...
  SELECT COUNT(*) AS Number_of_rows FROM CUSTCUSTDEMOGRAPHICS; -- THE NUMBER OF ROWS IN SALESORDER IS 0
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS;
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'CUSTCUSTDEMOGRAPHICS' ; -- THE NUMBER OF COULUMNS IN SALESORDER IS 2
...
CREATE TABLE Employee (
  ...
  SELECT COUNT(*) AS Number_of_rows FROM EMPLOYEE; -- THE NUMBER OF ROWS IN SALESORDER IS 9
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS;
select COUNT(*) AS NUMBER_OF_COLUMN FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'EMPLOYEE' ; -- THE NUMBER OF COULUMNS IN SALESORDER IS 20
